...
namespace Tests.UnitTests
{
    ...
    internal class DefaultTestValueCalculatorPrimitiveTypeTests
    {
        ...
        public void EnumTest()
        {
            ...
            List<IObjectInstance> vals = m_TestValueCalc.GetTestValues(typeof(StringComparison));
        ...
        {
            List<IObjectInstance> vals = m_TestValueCalc.GetTestValues(TestValueCalculator.BOOL_TYPE);
        ...
        {
            List<IObjectInstance> vals = m_TestValueCalc.GetTestValues(TestValueCalculator.BYTE_TYPE);
            Assert.That(vals.Count == 2);
        ...
        {
            List<IObjectInstance> vals = m_TestValueCalc.GetTestValues(TestValueCalculator.CHAR_TYPE);
            Assert.That(vals.Count == 2);
        ...
        {
            List<IObjectInstance> vals = m_TestValueCalc.GetTestValues(TestValueCalculator.DECIMAL_TYPE);
        ...
        {
            List<IObjectInstance> vals = m_TestValueCalc.GetTestValues(TestValueCalculator.DOUBLE_TYPE);
            Assert.That(vals.Count == 2);
        ...
        {
            List<IObjectInstance> vals = m_TestValueCalc.GetTestValues(TestValueCalculator.FLOAT_TYPE);
            Assert.That(vals.Count == 2);
        ...
        public void IntTest()
        {
            List<IObjectInstance> vals = m_TestValueCalc.GetTestValues(TestValueCalculator.INT_TYPE);
            Assert.That(vals.Count == 2);
        ...
        {
            List<IObjectInstance> vals = m_TestValueCalc.GetTestValues(TestValueCalculator.LONG_TYPE);
            Assert.That(vals.Count == 2);
        ...
        {
            List<IObjectInstance> vals = m_TestValueCalc.GetTestValues(TestValueCalculator.SBYTE_TYPE);
            Assert.That(vals.Count == 2);
        ...
        {
            List<IObjectInstance> vals = m_TestValueCalc.GetTestValues(TestValueCalculator.SHORT_TYPE);
            Assert.That(vals.Count == 2);
        ...
        {
            List<IObjectInstance> vals = m_TestValueCalc.GetTestValues(TestValueCalculator.UINT_TYPE);
            Assert.That(vals.Count == 2);
        ...
        {
            List<IObjectInstance> vals = m_TestValueCalc.GetTestValues(TestValueCalculator.ULONG_TYPE);
            Assert.That(vals.Count == 2);
        ...
        {
            List<IObjectInstance> vals = m_TestValueCalc.GetTestValues(TestValueCalculator.USHORT_TYPE);
            Assert.That(vals.Count == 2);
        ...
        {
            List<IObjectInstance> vals = m_TestValueCalc.GetTestValues(TestValueCalculator.STRING_TYPE);
        ...
        {
            List<IObjectInstance> vals = m_TestValueCalc.GetTestValues(TestValueCalculator.OBJECT_TYPE);
